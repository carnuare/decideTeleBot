...
def login(message): 
   ...
   if(len(texts)==3): 
      try: 
         ...
         url = 'https://decide-full-alcazaba-develop.herokuapp.com/authentication/login-bot/' 
...
def getVotacion(id_votacion): 
   url = 'https://decide-full-alcazaba-develop.herokuapp.com/voting/?id=' 
   url+=str(id_votacion) 
   payload={} 
   files={} 
   headers = {} 
               ...
               if(not id_opcion in diccionario_asignacion.keys()): 
                  ...
                  for opcion in diccionario_asignacion: 
                     ...
                     if(opcion == id_opcion): 
                        ...
                        url = "https://decide-full-alcazaba-develop.herokuapp.com/voting/encrypt/" 
                        ...
                        url2 = 'https://decide-full-alcazaba-develop.herokuapp.com/store/store-bot/' 
